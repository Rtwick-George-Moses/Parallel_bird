...
def save_pool():
    ...
    for xi in range(total_models):
        current_pool[xi].save_weights("model1/SavedModels/model_new" + str(xi) + ".keras")
...
def showGameOverScreen(crashInfo):
    ...
    if  generation > max_g:
            ...
            time_hold[0]= holder
            # save to csv file
            print("done_for this-round-mod1")
...
if load_saved_pool:
    for i in range(total_models):
        current_pool[i].load_weights("model1/SavedModels/model_new"+str(i)+".keras")
